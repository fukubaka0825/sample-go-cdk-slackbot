...
export class EventApiStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    // Lambda Function 作成
    const lambdaFunction: Function = new Function(this, "sample-event-lambda", {
      functionName: "sample-event-lambda", // 関数名
      ...
      environment: {
        ...
        "BOT_ID":"xxxxxxxxxx",
        "BOT_OAUTH":"xoxb-xxxxxxxxxxxxxxxxxxx-xxxxxxxxxxxxxxxxxxx"
      } // 環境変数
    })
    ...
    const restApi: RestApi = new RestApi(this, "sample-event-api", {
      restApiName: "sample-event-api", // API名
